...
var (
  ...
  {{.App.Name}} - {{.App.Usage}}
	...
	DNA CLI is an DNA node command line Client for starting and managing DNA nodes,
	managing user addresses, sending transactions, deploying and invoking contract, and so on.
